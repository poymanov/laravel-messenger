...
use App\Services\ChatUser\Factories\ChatUserChatInfoDtoFactory;
...
class ChatUserServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(ChatUserChatInfoDtoFactoryContract::class, ChatUserChatInfoDtoFactory::class);
    }
}
